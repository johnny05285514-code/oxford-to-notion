...
def release(version="v1.5.3", **overrides):
    payload = {
        "tag_name": version,
        "html_url": "https://github.com/johnny/repo/releases/tag/v1.5.3",
        "draft": False,
        "prerelease": False,
    }
...
def test_newer_stable_release_returns_update_and_writes_cache(tmp_path):
    ...
    assert result == UpdateInfo("1.5.3", release()["html_url"])
    ...
    assert payload["update"]["version"] == "1.5.3"
...
def test_fresh_cache_is_reused_without_network(tmp_path):
        ...
        json.dumps(
            {
                ...
                "update": {
                    "version": "1.5.3",
                    "release_url": "https://github.com/johnny/repo/releases/tag/v1.5.3",
                },
            }
        ),
        encoding="utf-8",
    ...
    assert result == UpdateInfo(
        "1.5.3", "https://github.com/johnny/repo/releases/tag/v1.5.3"
    )
