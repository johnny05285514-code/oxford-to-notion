...
def release(version="v1.5.2", **overrides):
    payload = {
        "tag_name": version,
        "html_url": "https://github.com/johnny/repo/releases/tag/v1.5.2",
        "draft": False,
        "prerelease": False,
    }
...
def test_newer_stable_release_returns_update_and_writes_cache(tmp_path):
    ...
    assert result == UpdateInfo("1.5.2", release()["html_url"])
    ...
    assert payload["update"]["version"] == "1.5.2"
...
def test_fresh_cache_is_reused_without_network(tmp_path):
        ...
        json.dumps(
            {
                ...
                "update": {
                    "version": "1.5.2",
                    "release_url": "https://github.com/johnny/repo/releases/tag/v1.5.2",
                },
            }
        ),
        encoding="utf-8",
    ...
    assert result == UpdateInfo(
        "1.5.2", "https://github.com/johnny/repo/releases/tag/v1.5.2"
    )
