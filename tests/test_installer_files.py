...
def test_nsis_installer_is_per_user_and_has_uninstall_support():
    ...
    assert 'File /oname=Oxford-to-Notion-v1.5.0.ico "assets\\app-icon.ico"' in script
    assert '"$INSTDIR\\Oxford-to-Notion-v1.5.0.ico" 0' in script
    assert 'Delete "$INSTDIR\\Oxford-to-Notion-v1.4.8.ico"' in script
